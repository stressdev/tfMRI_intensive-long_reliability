...
processVoxel <- function(v) {
  ...
  permutationRDS = '/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//panasneg.iv.happy//perm.free.panasneg.iv.happy/permute_free.RDS'
  targetDV = 'WCEN_PANASNEG'
  formula = BRAIN ~ 1 + TIMECENTER + GCEN_PANASNEG + WCEN_PANASNEG
