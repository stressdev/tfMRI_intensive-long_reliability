...
for file in ${files[@]}; do
  ...
  roifile=$(echo $file|sed -e "s#FaceReactivity1.feat/reg_standard/stats/cope4.nii.gz#HarvardOxford-sub-maxprob-thr50-2mm_FaceReactivity1_masked.nii.gz#")
