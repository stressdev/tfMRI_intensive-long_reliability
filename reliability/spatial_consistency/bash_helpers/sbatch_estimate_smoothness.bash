...
for file in ${files[@]}; do
  ...
  roifile=$(echo $file|sed -e "s#FaceReactivity1.feat/reg_standard/stats/cope4.nii.gz#Schaefer2018_400Parcels_7Networks_order_FSLMNI152_2mm_FaceReactivity1_masked.nii.gz#")
  
  maskfile="${ID}_${sess}_${ROI}.nii.gz"
