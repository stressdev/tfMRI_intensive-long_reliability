...
echo "Transforming HO for ${SUBSESS}..."

HO="/ncf/mclaughlin/stressdevlab/stress_pipeline/Group/FaceReactivity/3dICC/bicc/HarvardOxford-sub-maxprob-thr50-2mm.nii.gz"
TASK="faceReactivity"
RUN="FaceReactivity1"
FUNCMID="${SUBSESS}/${TASK}/${RUN}_FinalMidVol.nii.gz"
OUTFN=$( basename ${HO} )
OUTFN=${OUTFN%.nii}_${RUN}.nii
...
antsApplyTransforms -i ${HO} -d 3 -e 0 \
       -n MultiLabel \
	-r ${FUNCMID} \
