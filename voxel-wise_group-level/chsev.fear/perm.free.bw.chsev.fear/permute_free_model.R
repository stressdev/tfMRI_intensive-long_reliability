...
processVoxel <- function(v) {
  ...
  permutationRDS = '/shared//chsev.fear//perm.free.bw.chsev.fear/permute_free.RDS'
  targetDV = 'GCEN_CHRONICSEV'
  formula = BRAIN ~ 1 + TIMECENTER + GCEN_CHRONICSEV + WCEN_CHRONICSEV
