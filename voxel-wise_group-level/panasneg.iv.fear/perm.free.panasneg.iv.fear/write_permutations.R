...
load('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//panasneg.iv.fear/panasneg.iv.fear/debug.Rdata')
attach(designmat)
...
permpath <- file.path('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//panasneg.iv.fear//perm.free.panasneg.iv.fear', 'permute_free.RDS')
