...
processVoxel <- function(v) {
  ...
  if (!(is.null(panasneg.iv.happy))) {
    ...
    std_coefs <- coef(beta(panasneg.iv.happy))
  ...
  if(!(is.null(panasneg.iv.happy_sw))){
    coefs_sw <- panasneg.iv.happy_sw
