...
processVoxel <- function(v) {
  ...
  permutationRDS = '/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//time.happy//perm.free.time.happy/permute_free.RDS'
  targetDV = 'WCEN_TIMECENTER'
  formula = BRAIN ~ 1 + TIMECENTER
